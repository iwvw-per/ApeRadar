...
namespace ApeRadar.Utils.Converters
{
    internal class TagBackgroundColorConverter : IMultiValueConverter
    {
        ...
        public object Convert(object[] value, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            if (Properties.Settings.Default.ColorStyle == 0)
            {
                return ThemeManager.GetBrush("AppSurfaceBrush", Brushes.White);
            }
            ...
            bgcolor = Properties.Settings.Default.ColorStyle switch
            {
                1 => winrate! switch
                {
                    ...
                    _ => ThemeManager.GetColor("AppTagUnavailableBackgroundColor", Colors.LightGray),
                },
                2 => winrate switch
                {
                ...
                _ => ThemeManager.GetColor("AppSurfaceColor", Colors.White),
            };
