...
namespace ApeRadar
{
    partial class ConfigWindow : Window
    {
        ...
        {
            JObject JObjectWatchList = WatchListUtils.ReadWatchList(AppPaths.WatchListFile);
        ...
        private void ThemeManager_ThemeChanged(object? sender, EventArgs e)
        {
            ...
            {
                Dispatcher.Invoke(() => ThemeManager_ThemeChanged(sender, e));
                return;
            }

            BindingOperations.GetMultiBindingExpression(WeightedWinratePieChart, LiveChartsCore.SkiaSharpView.WPF.PieChart.SeriesProperty)?.UpdateTarget();
        }
        ...
        {
            WpfMenuItem? menu = sender as WpfMenuItem;
